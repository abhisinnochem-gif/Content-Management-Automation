"""
Doctor's Best Image Downloader — Plugin for download_webp.py
=============================================================
Exact same default flow as original download_webp.py:
  - Search by SKU then UPC, validate with BAD_SLUGS
  - Find gallery container, match images by UPC/SKU/name tokens
  - Remove BG, crop, resize to 4 sizes, save as JPEG

Usage:
    python doctorsbest_downloader.py --sku DRB00133 --upc 753950001336 --name "Alpha-Lipoic Acid" --folder resized_images/DRB00133
"""
...
DB_DOMAIN  = "doctorsbest.com"
BASE_URL   = "https://www.doctorsbest.com"
...
# Doctor's Best: no vendor prefix — relies on UPC/SKU token matching
VENDOR_PREFIXES = []
...
def process_excel(filepath):
    ...
    for row in ws.iter_rows(min_row=4, max_row=ws.max_row):
        ...
        if not url or DB_DOMAIN not in url: continue
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Doctor's Best Image Downloader")
    ...
    if args.sku and args.folder:
        ...
        print("Usage: doctorsbest_downloader.py --sku DRB00133 --upc 753950001336 --name 'Alpha-Lipoic Acid' --folder resized_images/DRB00133")
        sys.exit(1)
